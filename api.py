...
def requests_class_schedule(sf_cookie_17, jsessionid, year: int, term: int, only_week: bool = False, week: int = 0):
	cookies = {
		'SF_cookie_17': sf_cookie_17,
		'JSESSIONID': jsessionid,
	}
	params = {
		'gnmkdm': 'N2151' if not only_week else 'N2154',
	}
	data = {
		'xnm': year,
	...
	url = 'https://jwgl.gnnu.edu.cn/kbcx/xskbcx_cxXsgrkb.html' if not only_week else 'https://jwgl.gnnu.edu.cn/kbcx/xskbcxMobile_cxXsKb.html'
...
class Student:
	...
	def get_class_schedule(self, year: int, term: int, week: int = 0):
		...
		json = requests_class_schedule(self._cookie['SF_cookie_17'], self._cookie['JSESSIONID'], year, term, week != 0, week)
